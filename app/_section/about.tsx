...
export function AboutSection({ visible, about, trusteds }: AboutSectionProps) {
  return (
    <>
      <div className="relative flex flex-col justify-center items-center w-full h-screen">
        ...
        <div className="flex flex-col gap-y-10 w-full h-1/5 py-8">
          ...
          <div className="flex flex-row">
            ...
            <div
              className="flex flex-row gap-x-10 pr-10 animate-infinite-carousel-left"
              aria-hidden="true"
            >
              {trusteds.map((trusted, i) => (
                <img
