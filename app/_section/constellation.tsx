...
export function ConstellationSection({ visible }: ConstellationSectionProps) {
  return (
    <>
      <div className="w-full h-screen">
        <div className="relative flex flex-col items-center w-full h-full">
          ...
          <div
            className={`absolute -bottom-[5rem] flex flex-row gap-x-20 w-full justify-center items-center transition-opacity ease-in-out duration-1000 ${
