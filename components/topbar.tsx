export function Topbar(properties: any) {
	return <>
	<div className={`w-full h-16 absolute flex flex-row px-10 sm:px-20 transition-opacity duration-500 ${properties.visible ? "opacity-80" : "opacity-0"}`}>
		<div className="w-1/2 md:w-1/3 h-full flex items-center justify-start">
			<p className="text-white font-medium"> SMANSA </p>
		</div>
		<div className="hidden w-1/3 h-full md:flex flex-row gap-x-10 items-center justify-center">
